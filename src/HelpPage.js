        ...
        return (
            <>
                ...
                <div id="helpboxx">
                    ...
                    <h2> Sign Up</h2>
                    <p> In order to sign up to our website just click on Sign up enter your name, age, email and password and you are all set.
                    </p>
                    <h2> Login</h2>
                    <p>If you are existing user just login by enetering your credentials. Any issues related to logging in or signing up are latency related issues at the database. Please try refreshing the page. Make sure you enter your username and password correctly. Your username is your Name which is case sensitive, followed by your password, which too is case sensitive.</p>
